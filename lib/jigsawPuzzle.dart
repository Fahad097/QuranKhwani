...
import 'package:custom_timer/custom_timer.dart';import 'package:hexcolor/hexcolor.dart';
...
class JigsawPuzzlesState extends State<JigsawPuzzles> with TickerProviderStateMixin {
...
void dispose() {
  ...
  Widget build(BuildContext context) {
   final ButtonStyle style = ElevatedButton.styleFrom(
        primary: HexColor("#2a6e2d"), textStyle: const TextStyle(fontSize: 16));
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(child:  SafeArea(
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                JigsawPuzzle(
                  gridSize: 5,
                  image: const AssetImage('assets/image/jigsaw.png'),
                  onFinished: () {
                    // ignore: avoid_print
                       _controller.reset();
                  var point = 0;
          ...
          context,
          MaterialPageRoute(builder: (context) => GameResult('Jigsaw Puzzles',time,point)),
        );
                    print('finished!');
                  },
